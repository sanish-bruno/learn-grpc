...
Product.CreateProduct = {
  ...
  requestType: product_pb.ProductItem,
  responseType: product_pb.ProductItem
};
...
Product.ReadProducts = {
  ...
  requestStream: false,
  responseStream: false,
  requestType: product_pb.VoidParam,
  responseType: product_pb.ProductItems
};
...
Product.BatchCreateProducts = {
  ...
  responseStream: false,
  requestType: product_pb.ProductItem,
  responseType: product_pb.ProductBatchResponse
};
...
Product.MonitorProductPrices = {
  ...
  requestStream: true,
  responseStream: true,
  requestType: product_pb.PriceAlert,
  responseType: product_pb.PriceUpdate
};
